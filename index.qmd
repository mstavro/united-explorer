...
### Fleet Sample Flight Map
The flight map displays randomly selected flights from United's mainline fleet refreshed at preset intervals. At the preset interval, GitHub actions regenerates the dashboard with new flights. The current pull rate is 10 flights every 30 minutes.
