...
This dashboard is configured to display a different subset of **United's** fleet every hour. Click on any plane icon in the map for additional information. Map data as of `{r} Sys.time()` UTC
:::
